...
`;
type InputProps = Omit<React.ComponentPropsWithoutRef<'select'>, 'size'> & {
  size?: Scale;
...
export const Select = React.forwardRef<React.ElementRef<'select'>, InputProps>((props, forwardedRef) => {
  ...
  return (
    <InputGroup size={size}>
      ...
      <StyledSelect ref={forwardedRef} className={inputClassName} {...rest} />
